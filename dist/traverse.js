...
function _defaultTraverse(path) {
  ...
  return _react2.default.cloneElement.apply(
    _react2.default,
    [path.node, path.node.props].concat(
...
function _traverse(node, visitor) {
  var _visitor$Empty = visitor.Empty,
    ...
    Fragment = _visitor$Fragment === undefined
      ? _defaultTraverse
      : _visitor$Fragment,
    _visitor$DOMElement = visitor.DOMElement,
    DOMElement = _visitor$DOMElement === undefined
      ? _defaultTraverse
      : _visitor$DOMElement,
    _visitor$ComponentEle = visitor.ComponentElement,
    ComponentElement = _visitor$ComponentEle === undefined
      ? _defaultTraverse
      : _visitor$ComponentEle;
  ...
  var path = {
    ...
    traverse: function traverse(childNode) {
      var childVisitor = arguments.length > 1 && arguments[1] !== undefined
        ? arguments[1]
        : visitor;
    ...
    traverseChildren: function traverseChildren() {
      var childVisitor = arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : visitor;

      return _react2.default.Children
