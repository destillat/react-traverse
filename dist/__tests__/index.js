...
describe('sanity', function() {
  it('shouldjs should not extend Object.prototype', function() {
    return (0, _asFunction2.default)(Object.prototype).not.have.property(
      'should',
    );
  });
  it('Complex class transforms should work', function() {
    ...
    (0, _asFunction2.default)(multiplyByFortyFive()).be.exactly(
      TEN * THIRTYFIVE,
    );
    (0, _asFunction2.default)(
      _ComplexClass2.default.multiplyByFortyFive(TEN),
    ).be.exactly(TEN * THIRTYFIVE);
  });
